                ...
                <div class="tpl-user-panel-slide-toggleable">
                    ...
                    <div class="am-form-group am-form-file">
                        <div class="tpl-user-panel-profile-picture">
	                       <img src="/user/showPicture.do" width="66px" height="66px" onerror="javascript:this.src='/images/dayuan.jpg';" id='picture'>
	                    </div>
                         <form id="avatarForm" method="POST" enctype="multipart/form-data" action="/user/load.do" target="avatarFrame">
                        	<input id="doc-form-file" type="file" name="file" onchange="upload();">
                        </form>
                    </div>
